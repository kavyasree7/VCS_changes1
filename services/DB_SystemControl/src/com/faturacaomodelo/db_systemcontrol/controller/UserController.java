...
import com.faturacaomodelo.db_systemcontrol.service.UserService;
 ...
 * @see User
 */
@RestController("DB_SystemControl.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/DB_SystemControl/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("DB_SystemControl.UserService")
