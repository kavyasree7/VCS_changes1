...
import com.faturacaomodelo.db_systemcontrol.service.RoleService;
 ...
 * @see Role
 */
@RestController("DB_SystemControl.RoleController")
@Api(value = "RoleController", description = "Exposes APIs to work with Role resource.")
@RequestMapping("/DB_SystemControl/Role")
public class RoleController {

    private static final Logger LOGGER = LoggerFactory.getLogger(RoleController.class);

    @Autowired
	@Qualifier("DB_SystemControl.RoleService")
...
public Role createRole(@RequestBody Role roleInstance) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Role editRole(@PathVariable("id") Integer id, @RequestBody Role roleInstance) throws EntityNotFoundException {
