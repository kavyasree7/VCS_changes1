 ...
 * @see Product
 */
@Service("dbinvoice.ProductService")
public class ProductServiceImpl implements ProductService {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProductServiceImpl.class);

    @Autowired
	@Qualifier("dbinvoice.DocumentMediaLibraryService")
    ...
    @Autowired
    @Qualifier("dbinvoice.ProductDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table Product to {} format", exportType);
