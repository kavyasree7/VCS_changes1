 ...
 * @see Quotation
 */
@Service("dbinvoice.QuotationService")
public class QuotationServiceImpl implements QuotationService {
    ...
    @Autowired
    @Qualifier("dbinvoice.QuotationDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table Quotation to {} format", exportType);
