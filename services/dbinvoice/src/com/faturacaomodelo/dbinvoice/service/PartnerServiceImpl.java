 ...
 * @see Partner
 */
@Service("dbinvoice.PartnerService")
public class PartnerServiceImpl implements PartnerService {
    ...
    @Autowired
    @Qualifier("dbinvoice.PartnerDao")
	...
	public Partner create(Partner partner) {
        ...
        if(partnerCreated.getPartnerCodes() != null) {
            for(PartnerCode partnerCode : partnerCreated.getPartnerCodes()) {
                partnerCode.setPartner(partnerCreated);
        ...
        if(partnerCreated.getSocialContacts() != null) {
            for(SocialContact socialContact : partnerCreated.getSocialContacts()) {
                socialContact.setPartner(partnerCreated);
                LOGGER.debug("Creating a new child SocialContact with information: {}", socialContact);
                socialContactService.create(socialContact);
            }
        }
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table Partner to {} format", exportType);
    ...
    @Transactional(readOnly = true, value = "dbinvoiceTransactionManager")
    @Override
    public Page<SocialContact> findAssociatedSocialContacts(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated socialContacts");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("partner.id = '" + id + "'");

        return socialContactService.findAll(queryBuilder.toString(), pageable);
    }
