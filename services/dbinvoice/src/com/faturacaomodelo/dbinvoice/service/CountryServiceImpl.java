 ...
 * @see Country
 */
@Service("dbinvoice.CountryService")
public class CountryServiceImpl implements CountryService {
    ...
    @Autowired
    @Qualifier("dbinvoice.CountryDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table Country to {} format", exportType);
