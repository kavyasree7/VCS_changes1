 ...
 */
@Service("dbinvoice.BusinessPaymentMethodsRelService")
public class BusinessPaymentMethodsRelServiceImpl implements BusinessPaymentMethodsRelService {
    ...
    @Autowired
    @Qualifier("dbinvoice.BusinessPaymentMethodsRelDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table BusinessPaymentMethodsRel to {} format", exportType);
