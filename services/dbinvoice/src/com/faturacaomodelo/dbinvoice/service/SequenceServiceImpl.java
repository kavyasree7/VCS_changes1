 ...
 * @see Sequence
 */
@Service("dbinvoice.SequenceService")
public class SequenceServiceImpl implements SequenceService {
    ...
    @Autowired
    @Qualifier("dbinvoice.SequenceDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table Sequence to {} format", exportType);
