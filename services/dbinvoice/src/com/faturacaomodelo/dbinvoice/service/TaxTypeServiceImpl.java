 ...
 * @see TaxType
 */
@Service("dbinvoice.TaxTypeService")
public class TaxTypeServiceImpl implements TaxTypeService {
    ...
    @Autowired
    @Qualifier("dbinvoice.TaxTypeDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table TaxType to {} format", exportType);
