 ...
 * @see TaxRate
 */
@Service("dbinvoice.TaxRateService")
public class TaxRateServiceImpl implements TaxRateService {
    ...
    @Autowired
    @Qualifier("dbinvoice.TaxRateDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table TaxRate to {} format", exportType);
