 ...
 * @see InvoiceLine
 */
@Service("dbinvoice.InvoiceLineService")
public class InvoiceLineServiceImpl implements InvoiceLineService {
    ...
    @Autowired
    @Qualifier("dbinvoice.InvoiceLineDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table InvoiceLine to {} format", exportType);
