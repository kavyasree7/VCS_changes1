 ...
 * @see Payment
 */
@Service("dbinvoice.PaymentService")
public class PaymentServiceImpl implements PaymentService {
    ...
    @Autowired
    @Qualifier("dbinvoice.PaymentDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbinvoice for table Payment to {} format", exportType);
