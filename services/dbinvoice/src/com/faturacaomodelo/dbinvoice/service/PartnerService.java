...
public interface PartnerService {
    ...
    /*
     * Returns the associated partnerCodes for given Partner id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
    ...
    /*
     * Returns the associated socialContacts for given Partner id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated SocialContact instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<SocialContact> findAssociatedSocialContacts(Integer id, Pageable pageable);
