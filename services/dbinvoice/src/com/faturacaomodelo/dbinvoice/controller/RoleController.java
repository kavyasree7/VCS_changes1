...
import com.faturacaomodelo.dbinvoice.service.RoleService;
 ...
 * @see Role
 */
@RestController("dbinvoice.RoleController")
@Api(value = "RoleController", description = "Exposes APIs to work with Role resource.")
@RequestMapping("/dbinvoice/Role")
public class RoleController {

    private static final Logger LOGGER = LoggerFactory.getLogger(RoleController.class);

    @Autowired
	@Qualifier("dbinvoice.RoleService")
