...
import com.faturacaomodelo.dbinvoice.service.SettingsService;
 ...
 * @see Settings
 */
@RestController("dbinvoice.SettingsController")
@Api(value = "SettingsController", description = "Exposes APIs to work with Settings resource.")
@RequestMapping("/dbinvoice/Settings")
public class SettingsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(SettingsController.class);

    @Autowired
	@Qualifier("dbinvoice.SettingsService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Settings getSettings(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Settings editSettings(@PathVariable("id") Integer id, @RequestBody Settings settings) throws EntityNotFoundException {
        LOGGER.debug("Editing Settings with id: {}" , settings.getId());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSettings(@PathVariable("id") Integer id) throws EntityNotFoundException {
