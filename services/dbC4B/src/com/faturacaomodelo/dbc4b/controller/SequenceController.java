...
import com.faturacaomodelo.dbc4b.Sequence;
import com.faturacaomodelo.dbc4b.service.SequenceService;
...
public class SequenceController {
    ...
    public Sequence getSequence(@PathVariable("id") Integer id) throws EntityNotFoundException {
        ...
        Sequence foundSequence = sequenceService.getById(id);
        LOGGER.debug("Sequence details with id: {}" , foundSequence);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Sequence editSequence(@PathVariable("id") Integer id, @RequestBody Sequence sequence) throws EntityNotFoundException {
        LOGGER.debug("Editing Sequence with id: {}" , sequence.getId());

        sequence.setId(id);
        sequence = sequenceService.update(sequence);
    ...
    public boolean deleteSequence(@PathVariable("id") Integer id) throws EntityNotFoundException {
        ...
        Sequence deletedSequence = sequenceService.delete(id);

        return deletedSequence != null;
    }
