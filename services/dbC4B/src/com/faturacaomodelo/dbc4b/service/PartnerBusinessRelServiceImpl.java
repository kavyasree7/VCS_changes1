 ...
 */
@Service("dbC4B.PartnerBusinessRelService")
public class PartnerBusinessRelServiceImpl implements PartnerBusinessRelService {
    ...
    @Autowired
    @Qualifier("dbC4B.PartnerBusinessRelDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table PartnerBusinessRel to {} format", exportType);
