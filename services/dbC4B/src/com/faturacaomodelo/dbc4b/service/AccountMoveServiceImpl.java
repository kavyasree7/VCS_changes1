 ...
 * @see AccountMove
 */
@Service("dbC4B.AccountMoveService")
public class AccountMoveServiceImpl implements AccountMoveService {
    ...
    @Autowired
    @Qualifier("dbC4B.AccountMoveDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table AccountMove to {} format", exportType);
