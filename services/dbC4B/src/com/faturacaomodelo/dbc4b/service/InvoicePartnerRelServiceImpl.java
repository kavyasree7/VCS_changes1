 ...
 */
@Service("dbC4B.InvoicePartnerRelService")
public class InvoicePartnerRelServiceImpl implements InvoicePartnerRelService {
    ...
    @Autowired
    @Qualifier("dbC4B.InvoicePartnerRelDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table InvoicePartnerRel to {} format", exportType);
