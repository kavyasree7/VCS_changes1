 ...
 * @see FiscalSpace
 */
@Service("dbC4B.FiscalSpaceService")
public class FiscalSpaceServiceImpl implements FiscalSpaceService {
    ...
    @Autowired
    @Qualifier("dbC4B.FiscalSpaceDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table FiscalSpace to {} format", exportType);
