 ...
 * @see ProductType
 */
@Service("dbC4B.ProductTypeService")
public class ProductTypeServiceImpl implements ProductTypeService {
    ...
    @Autowired
    @Qualifier("dbC4B.ProductTypeDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table ProductType to {} format", exportType);
