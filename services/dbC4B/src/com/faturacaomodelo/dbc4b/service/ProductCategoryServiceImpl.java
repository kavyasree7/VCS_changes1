 ...
 * @see ProductCategory
 */
@Service("dbC4B.ProductCategoryService")
public class ProductCategoryServiceImpl implements ProductCategoryService {
    ...
    @Autowired
    @Qualifier("dbC4B.ProductCategoryDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table ProductCategory to {} format", exportType);
