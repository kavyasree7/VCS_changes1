 ...
 * @see AccountMoveLine
 */
@Service("dbC4B.AccountMoveLineService")
public class AccountMoveLineServiceImpl implements AccountMoveLineService {
    ...
    @Autowired
    @Qualifier("dbC4B.AccountMoveLineDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table AccountMoveLine to {} format", exportType);
