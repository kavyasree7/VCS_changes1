 ...
 */
@Service("dbC4B.DocumentMediaLibraryService")
public class DocumentMediaLibraryServiceImpl implements DocumentMediaLibraryService {
    ...
    @Autowired
    @Qualifier("dbC4B.DocumentMediaLibraryDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table DocumentMediaLibrary to {} format", exportType);
