 ...
 */
@Service("dbC4B.PartnerPaymentMethodsRelService")
public class PartnerPaymentMethodsRelServiceImpl implements PartnerPaymentMethodsRelService {
    ...
    @Autowired
    @Qualifier("dbC4B.PartnerPaymentMethodsRelDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table PartnerPaymentMethodsRel to {} format", exportType);
