 ...
 */
@Service("dbC4B.BusinessPaymentMethodsRelService")
public class BusinessPaymentMethodsRelServiceImpl implements BusinessPaymentMethodsRelService {
    ...
    @Autowired
    @Qualifier("dbC4B.BusinessPaymentMethodsRelDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table BusinessPaymentMethodsRel to {} format", exportType);
