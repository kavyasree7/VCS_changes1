 ...
 */
@Service("dbC4B.DocumentTemplateService")
public class DocumentTemplateServiceImpl implements DocumentTemplateService {
    ...
    @Autowired
    @Qualifier("dbC4B.DocumentTemplateDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table DocumentTemplate to {} format", exportType);
