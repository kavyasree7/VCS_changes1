 ...
 */
@Service("dbC4B.PartnerContactRelService")
public class PartnerContactRelServiceImpl implements PartnerContactRelService {
    ...
    @Autowired
    @Qualifier("dbC4B.PartnerContactRelDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table PartnerContactRel to {} format", exportType);
