 ...
 * @see FiscalPosition
 */
@Service("dbC4B.FiscalPositionService")
public class FiscalPositionServiceImpl implements FiscalPositionService {
    ...
    @Autowired
    @Qualifier("dbC4B.FiscalPositionDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B for table FiscalPosition to {} format", exportType);
