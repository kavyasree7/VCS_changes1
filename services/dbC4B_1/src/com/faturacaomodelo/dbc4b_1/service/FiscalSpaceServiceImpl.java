 ...
 * @see FiscalSpace
 */
@Service("dbC4B_1.FiscalSpaceService")
public class FiscalSpaceServiceImpl implements FiscalSpaceService {
    ...
    @Autowired
    @Qualifier("dbC4B_1.FiscalSpaceDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table FiscalSpace to {} format", exportType);
