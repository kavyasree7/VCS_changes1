 ...
 */
@Service("dbC4B_1.TaxInvoiceLineRelService")
public class TaxInvoiceLineRelServiceImpl implements TaxInvoiceLineRelService {
    ...
    @Autowired
    @Qualifier("dbC4B_1.TaxInvoiceLineRelDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table TaxInvoiceLineRel to {} format", exportType);
