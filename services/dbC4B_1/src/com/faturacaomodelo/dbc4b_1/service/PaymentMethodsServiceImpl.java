 ...
 * @see PaymentMethods
 */
@Service("dbC4B_1.PaymentMethodsService")
public class PaymentMethodsServiceImpl implements PaymentMethodsService {
    ...
    @Autowired
    @Qualifier("dbC4B_1.PaymentMethodsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table PaymentMethods to {} format", exportType);
