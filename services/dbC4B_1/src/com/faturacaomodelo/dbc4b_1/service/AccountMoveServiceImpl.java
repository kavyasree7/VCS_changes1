 ...
 * @see AccountMove
 */
@Service("dbC4B_1.AccountMoveService")
public class AccountMoveServiceImpl implements AccountMoveService {
    ...
    @Autowired
    @Qualifier("dbC4B_1.AccountMoveDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table AccountMove to {} format", exportType);
