...
@Service
public class DbC4B_1ProcedureExecutorServiceImpl implements DbC4B_1ProcedureExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DbC4B_1ProcedureExecutorServiceImpl.class);

    @Autowired
    @Qualifier("dbC4B_1WMProcedureExecutor")
