 ...
 * @see Country
 */
@Service("dbC4B_1.CountryService")
public class CountryServiceImpl implements CountryService {

    private static final Logger LOGGER = LoggerFactory.getLogger(CountryServiceImpl.class);

    @Autowired
	@Qualifier("dbC4B_1.TaxService")
	private TaxService taxService;

    @Autowired
	@Qualifier("dbC4B_1.FiscalPositionService")
	private FiscalPositionService fiscalPositionService;

    @Autowired
	@Qualifier("dbC4B_1.PaymentMethodsService")
	private PaymentMethodsService paymentMethodsService;

    @Autowired
    @Qualifier("dbC4B_1.CountryDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table Country to {} format", exportType);
