 ...
 * @see AccountMoveLine
 */
@Service("dbC4B_1.AccountMoveLineService")
public class AccountMoveLineServiceImpl implements AccountMoveLineService {
    ...
    @Autowired
    @Qualifier("dbC4B_1.AccountMoveLineDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table AccountMoveLine to {} format", exportType);
