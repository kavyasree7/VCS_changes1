 ...
 * @see Business
 */
@Service("dbC4B_1.BusinessService")
public class BusinessServiceImpl implements BusinessService {
    ...
    @Autowired
	@Qualifier("dbC4B_1.PartnerBusinessRelService")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table Business to {} format", exportType);
