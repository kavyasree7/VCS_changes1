 ...
 * @see Quotation
 */
@Service("dbC4B_1.QuotationService")
public class QuotationServiceImpl implements QuotationService {
    ...
    @Autowired
    @Qualifier("dbC4B_1.QuotationDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table Quotation to {} format", exportType);
