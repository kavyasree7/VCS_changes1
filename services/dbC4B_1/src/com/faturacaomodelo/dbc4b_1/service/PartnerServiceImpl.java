 ...
 * @see Partner
 */
@Service("dbC4B_1.PartnerService")
public class PartnerServiceImpl implements PartnerService {
    ...
    @Autowired
	@Qualifier("dbC4B_1.PaymentService")
    ...
    @Autowired
	@Qualifier("dbC4B_1.PartnerContactRelService")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table Partner to {} format", exportType);
