 ...
 * @see Currency
 */
@Service("dbC4B_1.CurrencyService")
public class CurrencyServiceImpl implements CurrencyService {
    ...
    @Autowired
	@Qualifier("dbC4B_1.ContactService")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbC4B_1 for table Currency to {} format", exportType);
