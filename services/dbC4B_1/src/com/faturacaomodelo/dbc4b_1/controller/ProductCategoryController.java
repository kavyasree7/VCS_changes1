...
import com.faturacaomodelo.dbc4b_1.service.ProductCategoryService;
 ...
 * @see ProductCategory
 */
@RestController("dbC4B_1.ProductCategoryController")
@Api(value = "ProductCategoryController", description = "Exposes APIs to work with ProductCategory resource.")
@RequestMapping("/dbC4B_1/ProductCategory")
public class ProductCategoryController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProductCategoryController.class);

    @Autowired
	@Qualifier("dbC4B_1.ProductCategoryService")
