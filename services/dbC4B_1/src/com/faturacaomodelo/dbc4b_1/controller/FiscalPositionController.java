...
import com.faturacaomodelo.dbc4b_1.service.FiscalPositionService;
...
public class FiscalPositionController {
    ...
    public Page<Partner> findAssociatedPartners(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return fiscalPositionService.findAssociatedPartners(id, pageable);
    }
